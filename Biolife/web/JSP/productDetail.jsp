<%-- 
    ...
    Created on : Oct 14, 2023, 10:57:38 PM
    Author     : Admin
--%>
                ...
                <div class="container">
                    <div class="top-bar left">
                        <ul class="horizontal-menu">
                            <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>Đào Quang Nguyên</a></li>
                            <li><a href="#">HE176610</a></li>
                        </ul>
                    </div>
                    <div class="top-bar right">
                        ...
                        <ul class="horizontal-menu">
                            ...
                            <li><a href="home" class="login-link"><i class="biolife-icon icon-login"></i>${p.fullname}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="minicart-contain">
                                        ...
                                        <div class="cart-content">
                                            <div class="cart-inner">
                                                ...
                                                <p class="btn-control">
                                                    <a href="viewcart" class="btn view-cart">view cart</a>
                    ...
                    <div class="sumary-product single-layout">
                        <div class="media">
                            <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                <li><img src="${pageContext.request.contextPath}/assets/images/products/${product.image}" alt="" width="500" height="500"></li>
                        ...
                        <div class="product-attribute">
                            ...
                            <div class="price">
                                <ins><span id="price-amount" class="price-amount"><span class="currencySymbol">£</span>${String.format("%.2f", product.price)}</span></ins>
                            </div>
                            ...
                            <div class="action-form">
                                <form action="viewcart" method="GET">
                                    ...
                                    <div class="quantity-box">
                                        ...
                                        <div class="qty-input">
                                            <input id="quantity" type="text" name="quantity" value="1" data-max_value="20" data-min_value="1" data-step="1" readonly>
                                            <input name="productID" type="hidden" value="${product.id}">
                                            <a onclick="increaseQuantity()" href="#" class="qty-btn btn-up"><i class="fa fa-caret-up" aria-hidden="true"></i></a>
                                            <a onclick="decreaseQuantity()" href="#" class="qty-btn btn-down"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="total-price-contain">
                                        <span class="title">Total Price:</span>
                                        <p id="price" class="price">£${String.format("%.2f", product.price)}</p>
                                    </div>
                                    <div class="buttons">
<!--                                        <a href="viewcart" class="btn add-to-cart-btn">add to cart</a>-->
...
<script>
                                                function increaseQuantity() {
                                                    let priceAmountText = document.getElementById("price-amount").textContent;
                                                    let quantity = Math.floor(document.getElementById("quantity").value) + 1;
                                                    document.getElementById("quantity").value = quantity;
                                                    document.getElementById("price").innerHTML = "£" + (priceAmountText.substr(1) * quantity);
                                                }

<%-- 
 ...
 Created on : Oct 14, 2023, 10:57:16 PM
 Author     : Admin
--%>
                ...
                <div class="container">
                    ...
                    <div class="top-bar right">
                        ...
                        <ul class="horizontal-menu">
                            ...
                            <li><a href="login.html" class="login-link"><i class="biolife-icon icon-login"></i>${fullname}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form class="shopping-cart-form" action="#" method="post">
                                    <table class="shop_table cart-form">
                                        ...
                                        <tbody>
                                        <h2>Total number: ${requestScope.totalQuan}</h2>
                                        <h3>Total type number: ${viewcart.size()}</h3>
                                        <c:forEach items="${viewcart}" var="v">    
                                            <tr class="cart_item">
                                                <td class="product-thumbnail" data-title="Product Name">
                                                    <a class="prd-thumb" href="#">
                                                        <figure><img width="113" height="113" src="${pageContext.request.contextPath}/assets/images/products/${v.image}" alt="shipping cart"></figure>
                                                    </a>
                                                    <a class="prd-name" href="#">${v.name}</a>
                                                    <div class="action">
                                                ...
                                                <td class="product-price" data-title="Price">
                                                    <div class="price price-contain">
                                                        <ins><span class="price-amount"><span class="currencySymbol">£</span>${String.format("%.2f", v.price)}</span></ins>
                                                    </div>
                                                </td>
                                                <td class="product-quantity" data-title="Quantity">
                                                    <div class="quantity-box type1">
                                                        <div class="qty-input">
                                                            <input id="quantity${v.id}" type="text" name="qty12554" value="${v.quantity}" data-max_value="20" data-min_value="1" data-step="1">
                                                            <a onclick="increaseQuantity('${v.id}', '${v.price}')" href="#" class="qty-btn btn-up"><i class="fa fa-caret-up" aria-hidden="true"></i></a>
                                                            <a onclick="decreaseQuantity('${v.id}', '${v.price}')" href="#" class="qty-btn btn-down"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="product-subtotal" data-title="Total">
                                                    <div class="price price-contain">
                                                        <ins><span id="total-price${v.id}" class="price-amount"><span class="currencySymbol"></span>£${String.format("%.2f", v.price * v.quantity)}</span></ins>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        <tr class="cart_item wrap-buttons">
                                            <td class="wrap-btn-control" colspan="4">
                                                <a class="btn back-to-shop" href="home">Back to Shop</a>
                                                <button class="btn btn-update" type="submit"  href="viewcart">update</button>
                                                <button class="btn btn-clear" type="reset" href="viewcart">clear all</button>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <div class="shpcart-subtotal-block">
                                    <div class="subtotal-line">
                                        <b class="stt-name">Subtotal <span class="sub">(2items)</span></b>
...
<script>
                                                                    function increaseQuantity(id, price) {
                                                                        console.log(id)
                                                                        let quantity = Math.floor(document.getElementById("quantity" + id).value) + 1;
                                                                        document.getElementById("total-price" + id).innerHTML = "£" + (price * quantity);
                                                                    }
                                                                    ...
                                                                    // Lấy tổng số sản phẩm và tổng quantity từ request
                                                                    const totalProduct = parseInt(document.getElementById("totalProduct").textContent);
                                                                    const totalQuantity = parseInt(document.getElementById("totalQuantity").textContent);

                                                                    // Hiển thị tổng số sản phẩm và tổng quantity

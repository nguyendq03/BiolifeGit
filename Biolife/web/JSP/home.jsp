...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Biolife - Fruit Shop</title>
                ...
                <div class="container">
                    ...
                    <div class="top-bar right">
                        ...
                        <ul class="horizontal-menu">
                            ...
                            <li><a class="login-link"><i
                                        class="biolife-icon icon-login"></i>${fullname}</a></li>
                            <li><a href="logout"  class="login-link">Logout  <i class="fa fa-sign-out" style="font-size: 18px; margin-left: 10px;" aria-hidden="true"></i></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                            <a href="home" class="biolife-logo"><img src="assets/images/organic-3.png"
                            ...
                            <div class="biolife-cart-info">
                                <div class="mobile-search">
                                    ...
                                    <div class="mobile-search-content">
                                        <form action="home" class="form-search"method="POST">
                                            <input type="text" name="txt" class="input-text" value=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 padding-top-2px">
                            <div class="header-search-bar layout-01">
                                <form action="home" class="form-search" name="desktop-seacrh" method="POST">
                            ...
                            <div class="slide-contain slider-opt03__layout01">
                                <div class="media">
                                    <div class="child-elememt">
                                        <a href="#" class="link-to">
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQqnfIAOlzcE8zA0QWHVtslt8yTdz0BsLUBQ&usqp=CAU" width="604" height="580"
                                                 alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="text-content">
                                    ...
                                    <h3 class="second-line"> 100% fresh fruit</h3>
                                    <p class="buttons">
                                ...
                                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                    <li class="tab-element active">
                                        <a href="#tab01_1st" class="tab-link"><span
                                                class="biolife-icon icon-lemon"></span>Fruit</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <c:forEach items="${requestScope.products}" var="p">
                                            <li class="product-item">
                                                <div class="contain-product layout-default">
                                                    <div class="product-thumb">
                                                        <a href="#" class="link-to-product">
                                                            <img src="${pageContext.request.contextPath}/assets/images/products/${p.image}" alt="Vegetables"
                                                                 width="270" height="270" class="product-thumnail">
                                                        </a>
                                                    </div>
                                                    <div class="info">
                                                        <b class="categories">${p.name}</b>
                                                        <h4 class="product-title"><a href="product?id=${p.id}" class="pr-name">${p.description}</a></h4>
                                                        <div class="price ">
                                                            <ins><span class="price-amount"><span
                                                                        class="currencySymbol">$</span>${String.format("%.2f", p.price)}</span></ins>
                                                        </div>
